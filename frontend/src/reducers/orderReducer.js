...
import {
    ORDER_ADD_REQUEST, ORDER_ADD_SUCCESS, ORDER_ADD_FAIL, ORDER_LIST_REQUEST,
    ...
    ORDER_DELETED_ITEM_REQUEST, ORDER_DELETED_ITEM_SUCCESS, ORDER_DELETED_ITEM_FAIL, CUSTOMER_ORDER_LIST_REQUEST, CUSTOMER_ORDER_LIST_SUCCESS, CUSTOMER_ORDER_LIST_FAIL, CUSTOMER_ORDER_DETAIL_REQUEST, CUSTOMER_ORDER_DETAIL_SUCCESS, CUSTOMER_ORDER_DETAIL_FAIL, GET_ORDER_HISTORY_REQUEST, GET_ORDER_HISTORY_SUCCESS, GET_ORDER_HISTORY_FAIL
} from "../constants/orderConstrains";
...
function orderDetailsReducer(state = { order: {}, charger: {}, shippingTo: {}, products: [] }, action) {
    switch (action.type) {
        ...
        case ORDER_DETAIL_SUCCESS:
            return {
                loading: false, success: true, order: action.payload.order, charger: action.payload.billingAddress,
        ...
        case ORDER_CHARGER_ADDRESS_UPDATE_SUCCESS:
            return {
                loading: false, success: true, ...state, order: state.order.map(x => (x.order_id === action.payload.orderId) ? (x.paymentType = action.payload.paymentType) : x),
...
function orderHistoryReducer(state = { orderStatusHistory: [], orderSendingPaymentHistory:[], billingAddressHistory: [], shippingAddressHistory: [], orderProductHistory: [] }, action) {
    switch (action.type) {
        case GET_ORDER_HISTORY_REQUEST:
            return { loading: true, orderStatusHistory: [], 
                billingAddressHistory: [], shippingAddressHistory: [], 
                orderSendingPaymentHistory:[],
                orderProductHistory: [] };
        case GET_ORDER_HISTORY_SUCCESS:
            return { loading: false, 
                orderStatusHistory: action.payload.orderStatusHistory, 
                billingAddressHistory: action.payload.billingAddressHistory, 
                shippingAddressHistory: action.payload.shippingAddressHistory,
                orderProductHistory: action.payload.orderProductHistory, 
                orderSendingPaymentHistory:action.payload.orderSendingPaymentHistory };
