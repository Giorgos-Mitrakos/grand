...
function SearchScreen(props) {
    ...
    useEffect(() => {
        dispatch(searchForItem(searchText, itemsPerPage, offset, filters, sortType));
    }, [itemsPerPage, currentPage, offset, filters, sortType]);
    ...
    return (
        <div>
            ...
            <ul className="order_items">
                ...
                <select className="filter_collection_per_page  select-model" onChange={(e) => itemsPerPageHandler(e.target.value)}>
                ...
                <select className="filter_collection_per_page select-model" value={sortType} onChange={(e) => setSortType(e.target.value)} selected={sortType}>
