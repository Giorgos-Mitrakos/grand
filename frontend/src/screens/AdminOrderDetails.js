...
function AdminOrdersDetailScreen(props) {
    ...
    const orderStatusList = ["Καταχωρήθηκε","Επεξεργάζετε", "Αναμονή", "Ολοκληρώθηκε", "Ακυρώθηκε"];
                                    ...
                                    <div className="modal-content">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <select type="text" value={orderSendingMethod} onChange={(e)=> sendingMethodHandler(e)}>
                                                    <option value="" disabled hidden>Επέλεξε τρόπο αποστολής</option>
                                            ...
                                            <li>
                                                <label>Τρόπος Πληρωμής:</label>
                                                <select type="text" value={orderPaymentMethod} onChange={(e)=> paymentMethodHandler(e)}>
                                                    <option value="" disabled hidden>Επέλεξε τρόπο πληρωμής</option>
                                                    {loadingPaymentMethods?<LoadingSpinner/>:
                                                    errorPaymentMethods?<div>{errorPaymentMethods}</div>:
                                                    paymentMethods.map(pay=>
                                                    <option id={pay.paymentMethod_id} cost={pay.paymentMethodCost} value={pay.paymentMethod} >{pay.paymentMethod}</option>)}
                                                </select>
                                            </li>
                                            <li>
                                                <label>Παραστατικό:</label>
                                        ...
                                        <div className="okCancelButton-wrapper">
                                            <button className="okCancelButton button" onClick={okOrderEditHandler}>OK</button>
                                                ...
                                                <ul className= "cart-item-width">
                                                    ...
                                                    <li className="cart-item cart-item-height " key={item._id + item.model}>
                                                        ...
                                                        <div className="cart-name">                                     
                                                            ...
                                                            value={item.quantity} onChange={(e)=>updateCartHandler(item._id,item.model,e.target.value)} >
